...
import { DashboardAPIReportComponent } from './dashboard-api-report.component';
import { NgbModule, NgbCalendar, NgbDate } from '@ng-bootstrap/ng-bootstrap';
import { CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';


describe('DashboardAPIReportComponent', () => {
    let component: DashboardAPIReportComponent;
    let fixture: ComponentFixture<DashboardAPIReportComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            imports: [NgbModule],
            declarations: [DashboardAPIReportComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(DashboardAPIReportComponent);
    ...
    it('should store initial data list', () => {
        expect(component).toBeTruthy();
        expect(component.dataList).toEqual(component.dataListInitial[component.detailId]);
    });
    ...
    it('should change dataList when calendar is not visible', () => {
        ...
        expect(component.dataList).toEqual(component.dataListAnotherVersion[component.detailId]);
    ...
    it('should not show Andriod filter when deleteFilter is called with corresponding filter name', () => {
        const filterName = 'Andriod';

        expect(component.showAndriodFilter).toBeTruthy();
        expect(component.showPaymentFilter).toBeTruthy();

        component.deleteFilter(filterName);
        expect(component.showAndriodFilter).toBeFalsy();
        expect(component.showPaymentFilter).toBeTruthy();
    });

    it('should not show Payment filter when deleteFilter is called with corresponding filter name', () => {
        const filterName = 'Payment';
        ...
        component.deleteFilter(filterName);
        expect(component.showAndriodFilter).toBeTruthy();
        expect(component.showPaymentFilter).toBeFalsy();
    });
});
