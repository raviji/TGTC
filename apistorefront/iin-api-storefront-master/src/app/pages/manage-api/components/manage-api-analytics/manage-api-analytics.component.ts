 ...
 */
@Component({
  selector: 'app-sd-manage-api-analytics',
  templateUrl: 'manage-api-analytics.component.html',
  styleUrls: ['manage-api-analytics.component.scss']
})
export class ManageApiAnalyticsComponent implements OnInit {
   ...
   */
  ngOnInit() {
    this.dataList = this.dataListInitial;
  ...
  changeData() {
    if (!this.showCalendar) {
      if (this.showInitial) {
        this.dataList = this.dataListAnotherVersion;
      } else {
        this.dataList = this.dataListInitial;
      }
