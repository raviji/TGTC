...
import { LineChartDoubleBiggerComponent } from './line-chart-double-bigger.component';

describe('LineChartDoubleBiggerComponent', () => {
    let component: LineChartDoubleBiggerComponent;
    let fixture: ComponentFixture<LineChartDoubleBiggerComponent>;
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [LineChartDoubleBiggerComponent]
        })
            .compileComponents();
    }));

    beforeEach(() => {
        fixture = TestBed.createComponent(LineChartDoubleBiggerComponent);
