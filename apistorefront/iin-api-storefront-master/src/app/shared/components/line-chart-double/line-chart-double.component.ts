 ...
 */
@Component({
  selector: 'app-sd-line-chart-double',
  templateUrl: 'line-chart-double.component.html',
  styleUrls: ['line-chart-double.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class LineChartDoubleComponent implements OnInit, OnChanges {
